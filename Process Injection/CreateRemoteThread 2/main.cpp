...
Note that shellcode is read externally via "calc.bin", this is a terrible implementation.
Consider defining shellcode in another source file and including it.
